...
class _FreePlayScreenState extends State<FreePlayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 1. طبقة زخرفة السدو (تم نسخها حرفياً من كودك الشغال بالشاشة الرئيسية)
          Positioned(
            left: -37,
            top: 0,
            bottom: 0,
            child: Opacity(
              opacity: 0.8,
              child: Image.asset(
                'assets/images/side_border_l.png', // المسار الصحيح 100%
                            ...
                            children: [
                              Expanded(
                                child: InteractiveDifficultyCard(
                                  ...
                                  activeColor: const Color(0xFF4CAF50), // أخضر
                                  onTap: () => setState(() {
...
class _InteractiveSelectorCardState extends State<InteractiveSelectorCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color bgColor = isActive ? const Color(0xFF1E1E1E) : Colors.white;
...
class _InteractiveDifficultyCardState extends State<InteractiveDifficultyCard> {
  ...
  Widget build(BuildContext context) {
    bool isActive = isPressed || widget.isSelected;
    final Color bgColor = isActive ? widget.activeColor : Colors.white;
    final Color contentColor = isActive
        ? Colors.white
        : const Color(0xFF1E1E1E);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        // هذا الكود يجبر الأيقونة تلتزم باتجاه اليسار لليمين مهما كانت لغة الجوال
